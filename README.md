...
I was obviously inspired by a cult such as "Dance Revolution", which I then transformed in this outragious, politically in-correct (I guess..), kinky masterpiece.
...
The user is given a starting time of 15 secs, which will either increase by five or decrease by ten whether the entered move matches the expected move, or not.

####Bonus

There is a special move that will be required 
